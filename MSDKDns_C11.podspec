...
Pod::Spec.new do |spec|
  ...
  spec.license      = { :type => "Copyright", :text => "©2021 Tencent.com"}
  ...
  spec.source       = { :http => "https://raw.githubusercontent.com/httpdns/httpdns-ios-sdk/master/release/C11/1.3.0/MSDKDns_C11.xcframework.zip" }
